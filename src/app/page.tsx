    ...
    <main className="min-h-screen flex flex-col font-sans bg-slate-950 text-slate-200">
      ...
      <section className="bg-slate-950 py-24 md:py-32 px-6 border-b border-slate-800">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-4 lg:sticky lg:top-24 space-y-8">
            ...
            <blockquote className="border-l-2 border-white/25 pl-6 py-6 italic text-lg text-slate-200 font-serif bg-slate-900/40 rounded-sm">
              ...
              <span className="text-sm text-slate-400 font-sans not-italic mt-4 block font-semibold">— Deep Tech COO</span>
            </blockquote>
          </div>
          <div className="lg:col-span-8 space-y-6 max-w-prose">
            ...
            <div className="bg-slate-900 border border-slate-700 p-6 rounded-sm my-4">
              <p className="text-base md:text-lg text-slate-200 leading-relaxed">
                To a legacy Quality Engineer or Utility Operator, a massive material reduction is not an efficiency gain—it is a glaring risk to system reliability. When your lean sales team sells innovation and virtue to a buyer who is financially incentivized to manage risk, you trigger their <span className="font-bold text-white">Fear of F*cking Up (FOFU)</span>.
              </p>
            </div>
            <p className="text-base md:text-lg text-slate-200 leading-relaxed">
              The deal enters a defensive stall in committee review, and your team is left throwing stones into the sea, waiting on external decisions you cannot control.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-900/50 py-24 md:py-32 px-6 border-b border-slate-800">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-8 space-y-8 max-w-prose">
            <p className="text-base md:text-lg text-slate-200 leading-relaxed">
              Every month an enterprise deal sits in committee review, your startup bleeds precious runway. You raised your last round on the promise of your technology&apos;s potential; you must raise your next round on the hard proof of your commercial revenue and pipeline velocity.
            </p>

            {/* Visual break — urgency callout */}
            <div className="bg-red-950/30 border border-red-900/40 p-6 rounded-sm">
              <p className="text-base md:text-lg text-slate-200 leading-relaxed font-medium">
                What happens to your next funding round if these enterprise pilots remain trapped in legal and get pushed to next year&apos;s fiscal budget?
              </p>
            </div>

            <blockquote className="border-l-2 border-white/25 pl-6 py-6 italic text-lg text-slate-200 font-serif bg-slate-950/50 rounded-sm">
              ...
              <span className="text-sm text-slate-400 font-sans not-italic mt-4 block font-semibold">— Clean Energy Founder</span>
            </blockquote>
            <p className="text-base md:text-lg text-slate-200 leading-relaxed">
              Time is your absolute enemy. The longer you rely on manual, founder-led sales motions and academic &quot;science project&quot; pitches, the faster your <span className="font-bold text-white">capitalization</span> erodes. You cannot afford to spend capital on generalized marketing retainers that generate LinkedIn impressions in an echo chamber, but yield zero closed-won utility pilots. Every day your team spends guessing at the right messaging is a day subtracted from your survival.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="group bg-slate-900 border border-slate-800 p-6 md:p-8 rounded-sm hover:border-slate-600 transition-all duration-500">
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-200 leading-relaxed">Visual physics briefs neutralizing reliability fears are injected into your Account Executive&apos;s playbook, effectively bypassing technical vetoes.</p>
                  <span className="inline-block mt-3 text-xs font-semibold uppercase tracking-wider text-slate-400 border-t border-slate-800 pt-3">Target → Quality Engineer</span>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-slate-900 border border-slate-800 p-6 md:p-8 rounded-sm hover:border-slate-600 transition-all duration-500">
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-200 leading-relaxed">ROI models and supply-chain volatility hedging sequences are drafted for your VP of Sales to satisfy procurement mandates.</p>
                  <span className="inline-block mt-3 text-xs font-semibold uppercase tracking-wider text-slate-400 border-t border-slate-800 pt-3">Target → CFO / Procurement</span>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-slate-900 border border-slate-800 p-6 md:p-8 rounded-sm hover:border-slate-600 transition-all duration-500">
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-200 leading-relaxed">Internal briefing documents are provided to arm your advocates to win the &quot;Lowest Bidder&quot; argument behind closed doors.</p>
                  <span className="inline-block mt-3 text-xs font-semibold uppercase tracking-wider text-slate-400 border-t border-slate-800 pt-3">Target → Internal Champion</span>
                </div>
              </div>
            </div>

            {/* Conclusion — visual break with arrow */}
            <div className="flex items-start gap-4 pt-6 mt-4 border-t border-slate-800">
              <ArrowRight className="w-5 h-5 text-white mt-1 shrink-0" />
              <p className="text-base md:text-lg text-slate-200 leading-relaxed max-w-prose">
      ...
      <section className="bg-slate-900/50 py-24 md:py-32 px-6 border-b border-slate-800">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-8 space-y-6 max-w-prose">
            ...
            {/* Visual break — value statement */}
            <div className="bg-slate-950/80 border-l-2 border-white/25 pl-6 py-4 rounded-sm">
              <p className="text-base md:text-lg text-white leading-relaxed font-medium">
                We map the market architecture. We index attention and engagement signals across the digital ecosystem to decode the exact psychological triggers of the gatekeepers blocking your deals.
              </p>
            </div>

            <p className="text-base md:text-lg text-slate-200 leading-relaxed">
              We deliver the diagnosis, fabricate the bifurcated assets, and inject them directly into your CRM. You receive the commercial blueprint and the executable assets without the operational bloat.
            </p>
          </div>
        </div>
      </section>

      {/* COMPONENT 6: VALUE PROPOSITIONS — Centered bottom card */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            <div className="relative">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <p className="text-base text-slate-200 leading-relaxed font-sans mt-4">We run proprietary attention and engagement signal mapping to decode the psychology of the specific gatekeepers blocking your stalled deals.</p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <p className="text-base text-slate-200 leading-relaxed font-sans mt-4">We build the Bifurcated GTM Matrix, segmenting your monolithic pitch into targeted, risk-mitigating tracks for the CFO, the Quality Engineer, and the Internal Champion.</p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <p className="text-base text-slate-200 leading-relaxed font-sans mt-4">We load the exact messaging assets directly into your CRM and enablement platforms. We give your commercial team the weapon; your VP of Sales pulls the trigger.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-950 py-24 md:py-32 px-6 border-b border-slate-800">
        <div className="max-w-5xl mx-auto space-y-16">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-base md:text-lg text-slate-200 leading-relaxed">Observe how we reverse-engineered stalled enterprise pipelines for deep-tech leaders.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-slate-900 border border-slate-800 hover:border-slate-600 transition-all duration-500 flex flex-col p-8 md:p-10 rounded-sm">
              <span className="text-xs font-bold tracking-widest uppercase text-slate-400 mb-3">PIPELINE VELOCITY</span>
              ...
              <div className="bg-slate-950 border border-slate-800 border-l-2 border-l-white p-6 mb-8 rounded-sm">
                ...
                <span className="block text-sm text-slate-300 mt-2">Higher executive engagement</span>
              </div>
              
              <ul className="space-y-3 mb-8 flex-grow text-slate-200">
                <li className="flex gap-3 items-start">
                  <span className="text-white/50 font-bold mt-0.5 text-sm">—</span>
            ...
            <div className="bg-slate-900 border border-slate-800 hover:border-slate-600 transition-all duration-500 flex flex-col p-8 md:p-10 rounded-sm">
              <span className="text-xs font-bold tracking-widest uppercase text-slate-400 mb-3">MARKET VALIDATION FOR PLASMA BORING</span>
              ...
              <div className="bg-slate-950 border border-slate-800 border-l-2 border-l-white p-6 mb-8 rounded-sm">
                ...
                <span className="block text-sm text-slate-300 mt-2">From zero to 103 decision-makers</span>
              </div>
      ...
      <section id="diagnostic-booking" className="relative bg-slate-950 py-24 md:py-32 px-6 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-10">
          ...
          <p className="text-lg text-slate-200 leading-relaxed font-sans max-w-2xl mx-auto">
          ...
          <div className="bg-slate-900 p-8 md:p-10 border border-slate-800 text-left mx-auto rounded-sm">
            <ul className="space-y-5">
              <li className="flex gap-4 items-start pb-5 border-b border-slate-800">
                ...
                <span className="text-lg text-slate-100 font-medium font-serif leading-relaxed">Are your deals trapped in <span className="text-white font-semibold">Pilot Purgatory</span>?</span>
              </li>
              <li className="flex gap-4 items-start pb-5 border-b border-slate-800">
                <span className="text-white font-bold mt-1 text-lg">✓</span>
                <span className="text-lg text-slate-100 font-medium font-serif leading-relaxed">Is procurement treating your breakthrough technology like a standard commodity?</span>
              </li>
              <li className="flex gap-4 items-start">
                <span className="text-white font-bold mt-1 text-lg">✓</span>
                <span className="text-lg text-slate-100 font-medium font-serif leading-relaxed">Are you currently using the same core pitch deck for the engineering team as you are for the financial buyer?</span>
              </li>
            </ul>
          </div>
          <div className="pt-4">
